...
public class ApiValidationMap extends HashMap<DeclaredType, ApiValidation> {
  @Inject
  private Logger logger;
  private List<? extends TypeMirror> validators;

  public List<? extends TypeMirror> getValidators() {
    return validators;
  }
  ...
  private void check(ValidationMethod validationMethod) {
    ...
    if (!containsKey(typeMirror)) {
      ...
      apiValidation.failCode = validationMethod.failCode();
